...
import 'package:mqtt/message.dart';
import 'package:mqtt/send_message.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  String broker            = '2399592ce1bb426ab53740ff10ce5634.s1.eu.hivemq.cloud';
  int port                 = 8883;
  String username          = 'mrjet';
  String passwd            = '0931392302Oo';
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<StreamSubscription>('subscription', subscription));
    properties.add(EnumProperty<mqtt.MqttConnectionState>('connectionState', connectionState));
  }
}